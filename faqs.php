...
<body>
  <header>
    ...
    <nav><a href="portfolio.php">Portfolio</a><a href="services.php">Services</a><a href="about.php">About Us</a><a href="faqs.php" class="active">FAQ'S</a><a href="contact.php">Contact</a></nav>
  </header>
  <div class="wrapper">
    <div class="left">
