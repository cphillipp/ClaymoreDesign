...
<head>
  ...
  <title>FAQ'S | Idaho Falls Web Design Company | Claymore Design</title>
...
<body>
  <div class="wrapper">
    <header>
      ...
      <nav><a href="index.php">Home</a><a href="portfolio.php">Portfolio</a><a href="services.php">Services</a><a href="about.php">About Us</a><a href="faqs.php" class="active">FAQ'S</a><a href="contact.php">Contact</a></nav>
    </header>
    <div class="main">
      <div class="left">
      ...
      <div class="right">        
        ...
        <section>
          ...
          <p>A: In the majority of cases a meeting isn’t necessary and most of our websites are generally completed with contact via email and telephone only. We place suggested website designs onto the Internet in a private place where only yourselves and us can view the content. We then liaise with you regularly to discuss the web designs in order that the website design and functionality is exactly as you wish.</p>
          <div class="line"></div>
          <h3>Q: How long will it take for my website to be designed?</h3>
          <p>A: The timescale of a website design project is often dictated by the client. If you have a deadline in mind we will endeavour to meet it for you. The most common delay in the creation and completion of a new website is waiting for content (text/images) to be sent to us by the client.</p>
          <div class="line"></div>
